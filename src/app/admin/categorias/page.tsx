  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <h1 className="text-2xl sm:text-3xl font-bold text-emerald-900 mt-1">Categorías</h1>
      </div>
                ...
                <table className="w-full text-sm min-w-120">
                  <thead>
                    <tr className="border-b border-gray-100 text-xs uppercase tracking-widest text-gray-400">
                      <th className="px-4 sm:px-6 py-3 text-left">CATEGORÍA</th>
                      <th className="px-3 sm:px-4 py-3 text-center">EDAD</th>
                      <th className="px-3 sm:px-4 py-3 text-center">FORMATO</th>
                      <th className="px-3 sm:px-4 py-3 text-center">GRUPOS</th>
                      <th className="px-3 sm:px-4 py-3 text-center">EQUIPOS</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-100">
                    {tournamentCategories.map((cat) => (
                      <tr key={cat.id}>
                        ...
                        <td className="px-3 sm:px-4 py-3 text-center text-gray-600">{cat.ageGroup}</td>
                        <td className="px-3 sm:px-4 py-3 text-center">
                          <span className="bg-emerald-100 text-emerald-800 text-xs px-2 py-0.5 rounded font-medium">
                            {cat.format}
                          </span>
                        </td>
                        <td className="px-3 sm:px-4 py-3 text-center text-gray-600">{cat.groups}</td>
                        <td className="px-3 sm:px-4 py-3 text-center font-medium text-emerald-900">{cat.teams}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
